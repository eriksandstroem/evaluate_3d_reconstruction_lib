...
name_dict = {
    "fuse_grids_tof_stereo_from_indep_trained_models_artificial_trunc": "fused_tof_psmnet",
    "left_bts_depth_artificial_trunc": "bts",
    "left_psmnet_depth_artificial_trunc": "psmnet",
    "left_depth_noise_5.0_artificial_trunc": "tof",
    "left_depth_gt_artificial_trunc": "gt",
}

mode_list = [
    "fuse_grids_tof_stereo_from_indep_trained_models_artificial_trunc",
    "gt_depth_artificial_trunc",
    "mono_no_routing_artificial_trunc",
    "multidepth_fusionNet_artificial_trunc",
    "multidepth_fusionNet_conditioned_artificial_trunc",
    "multidepth_routingNet_artificial_trunc",
    "multidepth_three_fusionNet_artificial_trunc",
    "multidepth_two_fusionNet_artificial_trunc",
    "stereo_artificial_trunc",
    "stereo_no_routing_artificial_trunc",
    "tof_artificial_trunc",
    "tof_no_routing_artificial_trunc",
]
# TSDF Fusion
print("===========================")
print("TSDF Fusion")
